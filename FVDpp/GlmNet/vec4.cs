...
namespace GlmNet
{
	...
	public struct vec4
    {
		...
		public static vec3 operator * (vec4 lhs, vec3 rhs)
		{
		...
		public static vec4 operator *(quat q, vec4 v)
		{
			vec3 r = q * new vec3(v);
			return new vec4(r.x, r.y, r.z, v.w);
		}
		...
		{
			return string.Format("[vec4: x {0}, y {1}, z {2}, w {3}]", x, y, z, w);
		}
    }
}